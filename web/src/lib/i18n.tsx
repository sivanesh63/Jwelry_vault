...
const en = {
  ...
  "common.next": "Next",
  "common.adminOnly": "Only an admin can change this",
  "common.you": "you",
  ...
  "scan.cameraNote":
    "Camera preview appears here once the scanner library is wired in. Use the button below to simulate a scan.",
  "scan.simulate": "Simulate scan",
  "scan.scanned": "Scanned",
  "scan.nothingScanned": "Nothing scanned yet",
  "scan.nothingScannedDesc": "Point the camera at a label, or simulate a scan above.",
...
const ta: Record<MessageKey, string> = {
  ...
  "common.adminOnly": "நிர்வாகி மட்டுமே இதை மாற்ற முடியும்",
  "common.you": "நீங்கள்",
  ...
  "scan.cameraNote":
    "ஸ்கேனர் நூலகம் இணைக்கப்பட்டவுடன் கேமரா காட்சி இங்கே தோன்றும். இப்போதைக்குக் கீழுள்ள பொத்தானைப் பயன்படுத்துங்கள்.",
  "scan.simulate": "ஸ்கேனை உருவகப்படுத்து",
  "scan.scanned": "ஸ்கேன் செய்யப்பட்டது",
  "scan.nothingScanned": "இதுவரை எதுவும் ஸ்கேன் செய்யப்படவில்லை",
  "scan.nothingScannedDesc": "லேபிளில் கேமராவைக் காட்டுங்கள், அல்லது மேலே ஸ்கேனை உருவகப்படுத்துங்கள்.",
